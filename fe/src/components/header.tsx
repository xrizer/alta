...
import { User, Bell, Menu, LogOut, Sun, Moon } from "react-feather";
    ...
    <header className="border-b border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
      <div className="flex h-14 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <button className="flex h-9 w-9 items-center justify-center rounded-full text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800">
            <Bell size={18} />
          </button>
