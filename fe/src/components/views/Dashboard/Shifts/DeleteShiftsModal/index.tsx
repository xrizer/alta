...
import useDeleteShiftsModal from './useDeleteShiftsModal';

interface PropsTypes {
  id: string;
}

const DeleteShiftModal = (props: PropsTypes) => {
  const { id } = props;
  const { mutateDeleteShift } = useDeleteShiftsModal();
