  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Add a new position</p>
      </div>
      <form onSubmit={handleSubmit} className="space-y-5 rounded-xl border border-gray-200 bg-white p-6">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-900 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500 disabled:bg-gray-100 disabled:text-gray-500"
            >
        ...
        <div className="flex justify-end gap-3">
          ...
          <button type="submit" disabled={isSubmitting} className="rounded-lg bg-orange-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-600 disabled:cursor-not-allowed disabled:opacity-50">{isSubmitting ? "Creating..." : "Create Position"}</button>
        </div>
      </form>
    </div>
  );
